...
import { Modal, Box, Button, TextField, MenuItem, Paper,
  Table, TableContainer, TableRow, TableBody, TableHead, TableCell } from '@mui/material';
  ...
  return (
    <div className="container">
      <div className="component-container">
        <h1 className="title">Vista de horas preliminar (alfa)</h1>
        <p className="paragraph">Tabla resumen de horas en el sistema</p>
          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell>Nombre Médico</TableCell>
            ...
            <TableBody>
              {reservas.map((reserva) => (
                <TableRow key={reserva.id}>
                  ...
                  <TableCell>{reserva.nombre_medico}</TableCell>
                  <TableCell>{reserva.atendido ? 'Sí' : 'No'}</TableCell>
                  <TableCell>{reserva.facturado ? 'Sí' : 'No'}</TableCell>
                  <TableCell>{reserva.pagado ? 'Sí' : 'No'}</TableCell>
                  <TableCell>
